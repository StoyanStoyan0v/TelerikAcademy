...
namespace BugLogger.RestApi.IntegrationTests
{
    ...
    public class BugsControllerIntegrationTests
    {
        ...
        [TestMethod]
        public void GetAfterParticularDate_WhenDateIsValid_ShouldReturnStatus200AndNonEmptyContent()
        {
            IRepository<Bug> repo = Mock.Create<IRepository<Bug>>();
            Bug[] bugs = { new Bug(), new Bug(), new Bug() };
            ...
            var response = server.CreateGetRequest("/api/bugs/22.04.2014");
        ...
        [TestMethod]
        public void GetBugByStatus_WhenStatusIsValid_ShouldReturnStatus200AndNonEmptyContent()
        {
            IRepository<Bug> repo = Mock.Create<IRepository<Bug>>();
            Bug[] bugs = { new Bug(), new Bug(), new Bug() };
            ...
            var response = server.CreateGetRequest("/api/bugs/fixed");
        ...
        [TestMethod]
        public void GetAfterParticularDate_WhenDateIsNotValid_ShouldReturnStatus500AndEmptyContent()
        {
            IRepository<Bug> repo = Mock.Create<IRepository<Bug>>();
            Bug[] bugs = { new Bug(), new Bug(), new Bug() };
            ...
            var response = server.CreateGetRequest("/api/bugs/20144.21.3213123as");
        ...
        [TestMethod]
        public void GetBugByStatus_WhenStatusIsNotValid_ShouldReturnStatus500AndEmptyContent()
        {
            IRepository<Bug> repo = Mock.Create<IRepository<Bug>>();
            Bug[] bugs = { new Bug(), new Bug(), new Bug() };
            ...
            var response = server.CreateGetRequest("/api/bugs/fixeddas");
