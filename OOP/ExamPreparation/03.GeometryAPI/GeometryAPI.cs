namespace GeometryAPI
{
    ...
    public class UpdatetFigureController : FigureController
    {
        private double radius;

        public UpdatetFigureController() : base()
        {
        }
        ...
        public override void ExecuteFigureCreationCommand(string[] splitFigString)
        {
            switch (splitFigString[0])
            {
                case "circle":
                    {
                        Vector3D location = Vector3D.Parse(splitFigString[1]);
                        radius = double.Parse(splitFigString[2]);
                ...
                case "cylinder":
                    {
                        Vector3D a = Vector3D.Parse(splitFigString[1]);
                        Vector3D b = Vector3D.Parse(splitFigString[2]);
                        radius = double.Parse(splitFigString[3]);
...
namespace AcademyGeometry
{
    ...
    class GeometryAPIi
    {
        ...
        {
            return new UpdatetFigureController();
        }
